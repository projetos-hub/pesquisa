...
The skill uses Read, Glob, Grep, and Bash tools exclusively. It cannot write files directly or execute as an agent, with a 40-turn conversation limit using Codex Sonnet.
